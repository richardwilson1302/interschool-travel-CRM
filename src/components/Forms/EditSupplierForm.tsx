...
export default function EditSupplierForm({ supplier, onClose }: EditSupplierFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    approx_price: supplier.approx_price || '',
    notes_for_groups: supplier.notes_for_groups || '',
    travel_time: supplier.travel_time || '',
